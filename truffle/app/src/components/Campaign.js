...
export class Campaign extends Component {
      ...
      <div>
        <Table celled padded color="teal" striped>
          ...
          <Table.Body>
            ...
            <Table.Row>
              <Table.Cell singleLine>Has finished</Table.Cell>
              <Table.Cell singleLine>
            ...
            <Table.Row>
              <Table.Cell singleLine>I am beneficiary</Table.Cell>
              <Table.Cell singleLine>
            ...
            <Table.Row>
              <Table.Cell singleLine>Contract state</Table.Cell>
  ...
  async onContribute(event) {
    ...
    campaign.totalCollected =
      Number.parseInt(campaign.totalCollected) + Number.parseInt(amount);
